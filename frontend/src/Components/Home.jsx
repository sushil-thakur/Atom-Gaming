    ...
    <div className="relative w-full" style={{ height: "95vh" }}>
      ...
      <div className="absolute top-60 left-45 flex flex-col items-start gap-2">
        <div className="flex items-center gap-3">
          <h1 className="h-6 w-12 bg-red-500 text-amber-50 flex items-center justify-center text-xs font-semibold">
            TIPS
          </h1>
          <span className="text-xs text-white">OCTOBER 29, 2019</span>
        </div>
        <div>
          <h1 className="bebas text-3xl font-bold tracking-wide text-amber-50">
        ...
        <div className="mt-44 flex flex-row items-stretch gap-8">
          ...
          <div className="flex flex-col justify-between h-0 items-start gap-4">
            <div className="flex items-center gap-3">
              <h1 className="h-6 w-12 bg-red-500 text-amber-50 flex items-center justify-center text-xs font-semibold">TIPS</h1>
              <span className="text-xs text-white">OCTOBER 29, 2019</span>
            </div>
            <h1 className="bebas text-xl font-bold tracking-wide text-amber-50 mt-2">
          ...
          <div className="flex flex-col justify-between h-0 items-start gap-4">
            <div className="flex items-center gap-3">
              <h1 className="h-6 w-12 bg-red-500 text-amber-50 flex items-center justify-center text-xs font-semibold">GAMES</h1>
          ...
          <div className="flex flex-col justify-between h-0 items-start gap-4">
            <div className="flex items-center gap-3">
              <h1 className="h-6 w-12 bg-red-500 text-amber-50 flex items-center justify-center text-xs font-semibold">ONLINE</h1>
              <span className="text-xs text-white">OCTOBER 18, 2019</span>
            </div>
            <h1 className="bebas text-xl font-bold tracking-wide text-amber-50 mt-2">
